...
import { DUE_STATUS_LABEL } from "@/lib/boards/due-date";
import type { DueInfo } from "@/lib/boards/view-model";
...
/**
 * Due date with its status: red when overdue, amber when due soon, green with
 * a check when done, neutral otherwise. The status is also spelled out for
...
export function DueBadge({
  ...
  return (
    ...
    >
      ...
      <time dateTime={due.iso}>{due.text}</time>
    </span>
  );
}
